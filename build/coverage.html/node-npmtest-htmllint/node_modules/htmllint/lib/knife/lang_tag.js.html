...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-htmllint/node_modules/htmllint/lib/knife/lang_tag.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-htmllint/node_modules/htmllint/lib/knife/lang_tag.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">38.46% <small>(5 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-htmllint/node_modules/htmllint/lib/knife/</a> &#187; lang_tag.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// List of ISO 639-1 language codes
var langCodes = [
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkLang(code) {</span>
<span class="cstat-no" title="statement not covered" >    return code.length === 0  ||  langCodes.indexOf(code) !== -1;</span>
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkCountry(code) {</span>
<span class="cstat-no" title="statement not covered" >    return code.length === 0  ||  countryCodes.indexOf(code) !== -1;</span>
}
&nbsp;
&nbsp;
...
module.exports.checkLangTag = <span class="fstat-no" title="function not covered" >function(l) {</span>
<span class="cstat-no" title="statement not covered" >    if (!l || l.length === 0) { <span class="cstat-no" title="statement not covered" >return 0; </span>}</span>
<span class="cstat-no" title="statement not covered" >    var n = l.lastIndexOf('-');</span>
<span class="cstat-no" title="statement not covered" >    var lang = '', country = '';</span>
<span class="cstat-no" title="statement not covered" >    if (n === -1) { <span class="cstat-no" title="statement not covered" >lang = l; </span>}</span>
    else { <span class="cstat-no" title="statement not covered" >lang = l.slice(0,n); <span class="cstat-no" title="statement not covered" ></span>country = l.slice(n + 1, l.length); </span>}
<span class="cstat-no" title="statement not covered" >    return (checkLang(lang) &amp;&amp; checkCountry(country)) ? 0</span>
